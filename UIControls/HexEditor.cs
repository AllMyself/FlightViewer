...
namespace UiControls
{
    ...
    /// 十六进制编辑器
    /// </summary>
    public sealed class HexEditor : Control
    {
        /// <summary>
        /// 界面区域类型
        /// </summary>
        ...
        public void LoadData(byte[] dataBytes)
        {

            memoryStream.SetLength(0);

            memoryStream = new MemoryStream(dataBytes);
            #region 字段初始化
        ...
        /// <param name="x">横向坐标</param>
        /// <param name="y">竖向坐标</param>
        private void DrawAddress(Graphics g, int line, int x, int y)
        {
            baseAddress = 0;
        ...
        /// <param name="x">横向坐标</param>
        /// <param name="y">竖向坐标</param>
        private void DrawSelection(HitTestType type, Graphics g, int line, byte[] buf, int len, int x, int y)
        {
            #region 绘制选中区
        ...
        /// <param name="x">横向坐标</param>
        /// <param name="y">竖向坐标</param>
        private void DrawHex(Graphics g, int line, byte[] buf, int len, int x, int y)
        {
        ...
        /// <param name="x">横向坐标</param>
        /// <param name="y">竖向坐标</param>
        private void DrawChar(Graphics g, int line,
